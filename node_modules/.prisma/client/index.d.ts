...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      Registro: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.RegistroFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.RegistroAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "password" | "isAdmin" | "isBlocked" | "lastLogin", ExtArgs["result"]["user"]>
  ...
  export type RegistroOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "data" | "tipoPonto" | "hora" | "foto", ExtArgs["result"]["registro"]>
  ...
  export interface RegistroDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Registros that matches the filter.
     * @param {RegistroFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const registro = await prisma.registro.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: RegistroFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Registro.
     * @param {RegistroAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const registro = await prisma.registro.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: RegistroAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface RegistroFieldRefs {
    ...
    readonly userId: FieldRef<"Registro", 'String'>
    readonly data: FieldRef<"Registro", 'DateTime'>
    readonly tipoPonto: FieldRef<"Registro", 'String'>
    readonly hora: FieldRef<"Registro", 'String'>
    readonly foto: FieldRef<"Registro", 'String[]'>
  }
   ...
   * Registro findRaw
   */
  export type RegistroFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * Registro aggregateRaw
   */
  export type RegistroAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type RegistroWhereInput = {
    ...
    userId?: StringFilter<"Registro"> | string
    data?: DateTimeFilter<"Registro"> | Date | string
    tipoPonto?: StringFilter<"Registro"> | string
    hora?: StringFilter<"Registro"> | string
    foto?: StringNullableListFilter<"Registro">
  ...
  export type RegistroScalarWhereWithAggregatesInput = {
    ...
    userId?: StringWithAggregatesFilter<"Registro"> | string
    data?: DateTimeWithAggregatesFilter<"Registro"> | Date | string
    tipoPonto?: StringWithAggregatesFilter<"Registro"> | string
    hora?: StringWithAggregatesFilter<"Registro"> | string
    foto?: StringNullableListFilter<"Registro">
  }
  ...
  export type RegistroCreateInput = {
    ...
    tipoPonto: string
    hora: string
    foto?: RegistroCreatefotoInput | string[]
  ...
  export type RegistroUpdateInput = {
    ...
    tipoPonto?: StringFieldUpdateOperationsInput | string
    hora?: StringFieldUpdateOperationsInput | string
    foto?: RegistroUpdatefotoInput | string[]
  ...
  export type RegistroCreatefotoInput = {
    set: string[]
  }
  ...
  export type RegistroUpdatefotoInput = {
    set?: string[]
    push?: string | string[]
  }
